...
preprocessedResoldProps <-
  ...
  # Paused here - need to think about what other data I can
  # bring back in to make worthwhile predictions...
  # Perhaps bringing these columns back into the other
  # table except where the rows on the other table are most recent
  # (e.g., if a property sold twice, only join on the older listing...
  # If the property sold three times, add these rows every time except
  # the most recent? But then it would be better to calculate the
  # "valueIncreasePerYear" not just from last - first, but for all
  # in between!
